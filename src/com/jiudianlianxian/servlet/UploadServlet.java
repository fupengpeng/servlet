			...
			for(FileItem fileItem : list){
				if(fileItem.isFormField()){
					...
					if("str1".equals(fileItem.getFieldName())){
						// 如果该 FileItem 名称为 str1
						out.println("遍历到 str1 ... <br/>");
						str1 = new String(fileItem.getString().getBytes(), "UTF-8");
					}
					if("str2".equals(fileItem.getFieldName())){
						// 如果该 FileItem 名称为 str2
						out.println("遍历到 str2 ... <br/>");
					...
					if("file1".equals(fileItem.getFieldName())){
						...
						out.println("客户端文件位置: " + remoteFile.getAbsolutePath() + "<br/>");   //遍历出的文件当前所在绝对路径
...
//						file1 = new File(this.getServletContext().getRealPath("attachment"), remoteFile.getName());
						...
						try{
							...
							out.println("已保存文件" + file1.getAbsolutePath() + "<br/>");  //上传后，文件所保存的绝对路径
						}finally{
							ous.close();
							ins.close();
						}
